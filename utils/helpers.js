...
export function formatDate(date, locale = 'pt-BR') {
  ...
  try {
    ...
    if (isDevelopment()) console.error('Erro ao formatar data:', error);
    return '';
  }
}
...
export function formatDateTime(date, locale = 'pt-BR') {
  ...
  try {
    ...
    if (isDevelopment()) console.error('Erro ao formatar data/hora:', error);
    return '';
  }
}
...
export async function copyToClipboard(text) {
  try {
    ...
    if (isDevelopment()) console.error('Erro ao copiar para clipboard:', error);
    return false;
  }
}
...
export function setLocalStorage(key, value) {
  try {
    ...
    if (isDevelopment()) console.error('Erro ao salvar no localStorage:', error);
    return false;
  }
}
...
export function getLocalStorage(key, defaultValue = null) {
  try {
    ...
    if (isDevelopment()) console.error('Erro ao recuperar do localStorage:', error);
    return defaultValue;
  }
}
...
export function removeLocalStorage(key) {
  try {
    ...
    if (isDevelopment()) console.error('Erro ao remover do localStorage:', error);
    return false;
  }
}
