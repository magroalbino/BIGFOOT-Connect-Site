...
export default function Login() {
  ...
  // Inicialização do tema (protegido contra SSR)
  useEffect(() => {
  ...
  // Toggle tema (protegido contra SSR)
  const toggleTheme = () => {
    if (typeof window === 'undefined') return;
  ...
  // Google login (sem logs de depuração e sem armazenar email)
  ...
  // Submit do formulário (com validação de email e sem localStorage)
