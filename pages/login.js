...
export default function Login() {
  ...
  // Forgot password - redireciona para página dedicada
  ...
  return (
    <>
      ...
      {/* 
        ...
        Antes: sem font-family definida (usava default do sistema).
      */}
      <div 
        ...
        <div className="w-full max-w-md z-10 animate-slide-in-up">
          ...
          <div className="flex flex-col items-center mb-10 animate-fade-in-scale">
            ...
            {/* 
              ...
              Igual ao header do index para consistência.
            */}
            <span 
          ...
          <div className={`${isDark ? 'bg-gray-900/80 border-gray-800' : 'bg-white border-gray-200'} border backdrop-blur-2xl rounded-3xl p-10 shadow-2xl relative overflow-hidden`}>
            ...
            {/* 
              MUDANÇA: Título do form usa Space Grotesk weight 700.
              Tracking negativo para coerência com o resto do site.
            */}
            <h2 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                {/* 
                  ...
                  letter-spacing levemente positivo (0.1px) para legibilidade.
                */}
                <label
                  htmlFor="email"
              ...
              <button
                ...
                disabled={loading}
                className={`w-full ${isDark ? 'bg-white/5 hover:bg-white/10 border-gray-800' : 'bg-gray-50 hover:bg-white border-gray-300'} border py-3 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg flex items-center justify-center gap-3 font-medium disabled:opacity-60 disabled:cursor-not-allowed`}
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: '0.1px' }}
              >
