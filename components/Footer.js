  ...
  const footerLinks = [
    {
      title: t.footerAbout,
      links: [
        { label: t.footerWhitepaper, href: '/docs/whitepaper.pdf' },
        { label: t.footerRoadmap, href: '/#roadmap' },
        { label: t.footerToken, href: '/#token' },
      ]
    },
    {
      title: t.footerResources,
      links: [
        { label: t.footerDashboard, href: '/dashboard' },
        { label: t.footerPools, href: '/pools' },
        { label: t.footerDownload, href: '/#download' },
      ]
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} text-sm mb-4`}>
              {t.footerDescription || 'Rode um nó Proof of Relay e ganhe recompensas em tokens BIG.'}
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} text-sm text-center md:text-left`}>
            © {currentYear} BIGFOOT Connect. {t.footerRights}
          </p>
